  ...
  return (
    <main className="min-h-screen bg-cream text-cocoa">
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden px-5 py-24">
        ...
        <Card className="liquid-glass relative z-10 mx-auto max-w-3xl p-7 text-center sm:p-10">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-sage/65">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-cocoa/75">
            {isAttending
              ? "We received your RSVP and cannot wait to celebrate Charlotte Ysabella's farm-tastic first birthday with you."
              : "We received your RSVP. Thank you for letting the family know."}
          </p>

          {isAttending && (
            <div className="mx-auto mt-8 grid max-w-xl gap-3 rounded-3xl bg-white/55 p-5 text-left shadow-soft sm:grid-cols-2">
